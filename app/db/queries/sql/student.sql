...
INSERT INTO student (name, phone, gender, address, date_of_birth, class_id)
VALUES (:name, :phone, :gender, :address, :date_of_birth, :class_id)
RETURNING id;
...
UPDATE class
SET quantity = quantity + :variable
WHERE id = :class_id

-- name: update_quantity_change_class
UPDATE class
SET quantity = quantity + :variable
WHERE id = :class_id
